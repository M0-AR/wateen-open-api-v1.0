import fs from 'fs';
import type { ResponseLike } from 'wateen-open-api-v1.0/internal/to-file';
import { toFile } from 'wateen-open-api-v1.0/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('wateen-open-api-v1.0/core/uploads');
    await expect(
