...
export { ClientOptions } from 'wateen-open-api-v1.0';
...
export function initMcpServer(params: {
  ...
  const client = new WateenOpenAPIV1_0(params.clientOptions);
  const capabilities = {
    ...defaultClientCapabilities,
...
export function init(params: {
  ...
  const client =
    params.client || new WateenOpenAPIV1_0({ defaultHeaders: { 'X-Stainless-MCP': 'true' }, logger: logger });
